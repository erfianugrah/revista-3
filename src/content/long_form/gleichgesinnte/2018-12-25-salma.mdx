...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    <div class="col-span-1">
        <a href ="https://erfianugrah.com/content/images/2021/08/Salma-1.jpg"  data-fslightbox="gallery">
            <img src="https://erfianugrah.com/content/images/2021/08/Salma-1.jpg" />
        </a>
    </div>
    <div class="col-span-1">
        <a href ="https://erfianugrah.com/content/images/2021/08/Salma-2-1.jpg"  data-fslightbox="gallery">
