...
image:
  {
    src: https://cdn.erfianugrah.com/120-221109-0003.jpg,
    alt: zeitweilig_1,
    positionx: 65%,
    positiony: 40%,
  }
...
import since94 from "../../scripts/since94.ts";
...
<sup>1</sup>*Erfinism can refer to both the overall study of the Erfi – hereby
centered around the driving question of “What is Erfi?” – as well as the Erfi’s
...
_Disclaimer: Not in line with a traditional exposé structure, the following paragraphs provide a brief outline of the possible contents of a dissertation in Erfinism._
...
<sup>4</sup>*The sensation of 'feeling truly seen' is only charming as long as
the ugly parts are politely overlooked - but the Erfi sees it all.*
...
<sup>5</sup>*As human-seeming the flirty comments of the Erfi are, they tend to
come up a tad too smooth and quickly, sowing the suspicion of a flirt-bot
running its program.*
